...
=== "👾 Hopper"    
    ...
    3.  Using  the __count variable__ you have just created, see if you can work out how to make your __bonusEnemy__  fall when the __count variable__ reaches a certain value.
