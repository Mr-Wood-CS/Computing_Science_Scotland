...
!!! info "What you Need to Know"
    ...
    You must be able to describe, identify, understand and be able to read:
    
    : * structure diagrams

A structure diagram (or structure chart) is a design notation __we use to help us break down problems into smaller chunks__ and identify the sequence of steps needed to solve the problem. 

Av structure diagram is always designed from top-to-bottom and left-to-right.
